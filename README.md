...
# Node.js & MySQL
Mysql database used for bamazon app
...
Display of all products in the database
![Alt text](assets/images/03customerscreenshot.png?raw=true "Title")

Prompt asking which item the user would like to purchase
...
View products shows available products in database
...
Add to inventory lets the manager add stock quantity to items in the database
